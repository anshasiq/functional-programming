...
public class StatesAndCapitals
{
    ...
    public void testStatesAndCapitals() throws IOException
    {
        ...
        Boolean doNoStatesHaveAOneWordMotto = states.stream().noneMatch (a -> a.getStateMotto().split(" ").length == 1);
        ...
        Double averageYearlyPrecipitationAcrossStateCapitals = states.stream().collect(averagingDouble(a -> a.getCapital().getAverageYearlyPrecipitationInInches()));
        ...
        Map<String, Long> numberOfStatesByTimeZone = states.stream().collect(groupingBy(a->a.getTimeZones().toString(),counting()));
        ...
        Map<String, Long> numberOfStateCapitalsByTimeZone = states.stream().collect(groupingBy(a ->a.getCapital().getTimeZone() , counting()));
